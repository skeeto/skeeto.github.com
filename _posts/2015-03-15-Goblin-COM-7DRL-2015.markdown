...
hire heroes, manage squads, construct buildings, and manage resource
income.
...
had its first major (1.0) release last year. Like the early days of
...
playable on any modern machine. I **didn't make use of ncurses**,
instead opting to write my own terminal graphics engine. That's
because I wanted a [single, small binary][dos] that was easy to build,
and I didn't want to mess around with [PDCurses][pd]. I've also been
studying the Win32 API lately, so writing my own terminal platform
layer would rather easy to do anyway.
...
[y2014]: http://nullprogram.com/blog/2013/03/17/
[y2013]: http://nullprogram.com/blog/2014/03/31/
...
[dos]: http://nullprogram.com/blog/2014/12/09/
[pd]: http://pdcurses.sourceforge.net/
[pitfall]: http://nullprogram.com/blog/2014/06/13/
