...
generated by a few
[Elisp Markov chain functions](https://github.com/skeeto/markov-text). I
fed my entire blog into it and let it generate a ~1500 word post. I
...
Princess of Mars* I had a good laugh at some of the output. Some
choice quotes,
